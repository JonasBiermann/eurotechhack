...
export const DICT: Record<string, Entry> = {
  ...
  'stats.dest.sub':         { en: 'Applications per city · avg match score',
                              zh: '各城市申請數 · 平均配對分數' },
  'stats.cohorts.title':    { en: 'Same-city communities',    zh: '同城社群' },
  'stats.cohorts.total':    { en: 'connected residents',      zh: '已連繫居民' },
  'stats.cohorts.sub':      { en: 'Residents who opted in to relocate together — each city has an assigned caseworker who mediates introductions.',
                              zh: '選擇結伴遷居的居民 — 每個城市均有指定個案主任安排介紹。' },
  'stats.cohorts.settled':  { en: 'settled',                  zh: '已安頓' },
  'stats.cohorts.approved': { en: 'approved',                 zh: '已批准' },
  'stats.cohorts.pending':  { en: 'in progress',              zh: '進行中' },
  'stats.cohorts.caseworker': { en: 'Caseworker',             zh: '個案主任' },
